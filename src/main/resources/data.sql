...
values (21, 1, 'parent 댓글 1', null, now(), now()),
       (21, 2, 'parent 댓글 2', null, now(), now()),
       (21, 2, 'parent 댓글 1 대댓글 1', 1, now(), now()),
       (21, 2, 'parent 댓글 1 대댓글 2', 1, now(), now()),
       (21, 2, 'parent 댓글 1 대댓글 3', 1, now(), now()),
       (21, 2, 'parent 댓글 2 대댓글 1', 2, now(), now()),
       (21, 2, 'parent 댓글 2 대댓글 2', 2, now(), now()),
       (21, 2, 'parent 댓글 2 대댓글 3', 2, now(), now());